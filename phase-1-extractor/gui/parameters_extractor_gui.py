...
class ParametersExtractorGUI(object):
    def __init__(self, main_window):
        ...
        icon = QtGui.QIcon()
        project_dir = __file__.removesuffix("\\gui\\parameters_extractor_gui.py").replace("\\", "/")
        icon.addPixmap(QtGui.QPixmap(project_dir + "/imgs/Icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
